...
export default class SnipdPlugin extends Plugin {
  ...
  async onload() {
    addIcon('snipd', `<path d="M65.1755 34.6979L77.8198 22.5038C65.1778 9.83203 43.8825 9.83207 31.2404 22.5039C18.5984 35.1757 19.0877 56.7919 31.7297 69.4637L22.7375 78.4771M30.9984 69.2158L22.7376 77.4962C35.3796 90.1679 55.8764 90.1679 68.5185 77.4961C80.1778 65.8094 81.0841 47.4258 71.2374 34.6979C70.4075 33.6251 69.5012 32.5925 68.5185 31.6075" stroke="#B2B2B2FF" stroke-width="8.33333" fill="none"/>`);
